...

{
     public class ArticuloNegocio
    {
        ...
        public void Modificar(Articulo modificar)
        {
            ...
            try
            {
                datos.setearConsulta("update ARTICULOS set Codigo = '" + modificar.Cod_Articulo + "', Nombre = '" + modificar.Nombre_Articulo + "', Descripcion = '" + modificar._Descripcion + "', IdMarca = " + modificar.Id_marca +", IdCategoria = " + modificar.Id_cate + " ,Precio = " + modificar.Precio + " where Id = "+ modificar.Id +"");
